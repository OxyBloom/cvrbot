...
def generate_launch_description():
    ...
    ebot_real_nav2_dir = get_package_share_directory('cvrbot_nav2')
    ...
    declare_mapper_online_async_param_cmd = DeclareLaunchArgument(
        'async_param',
        default_value=os.path.join(ebot_real_nav2_dir, 'config', 'hardware', 'mapper_params_online_async.yaml'),
    ...
    # xacro_file = os.path.join(get_package_share_directory('cvr_bot_description'), 'urdf/', 'robot.urdf.xacro')
...
#######################3
    # twist_mux_params = os.path.join(get_package_share_directory('cvr_bot_description'),'config','twist_mux.yaml')
    # twist_mux = Node(
    #         package="twist_mux",
    ...
    # controller_params_file = os.path.join(get_package_share_directory('cvr_bot_description'),'config','my_controllers.yaml')
